...
public class MailService {
	...
	public void sendEmailInsertion(String email, String name, Integer idDemande) throws MailException{
		...
		mail.setTo(email);
		mail.setSubject("Application pour credit");
		mail.setText("Bonjour Monsieur/Madame "+name+", \n\n"
				...
				+ "Vous recevrez un mail dés que votre demande est traité\n"
				+ "A bientôt. \n"
				+ "\n"
	...
	public void sendEmailRDV(String email, String name,Integer idDemande) throws MailException{
